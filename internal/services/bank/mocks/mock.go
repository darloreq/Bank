...
func (mr *MockBankReposIMockRecorder) MakeUser(user interface{}) *gomock.Call {
...
func (mr *MockBankReposIMockRecorder) PutMoneyInDB(userID, amountPut interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBankReposIMockRecorder) ShowBalance(userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
